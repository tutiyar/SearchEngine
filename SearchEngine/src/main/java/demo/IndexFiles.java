...
public class IndexFiles {
  ...
  public static void indexing() {
    ...
    */
    ...
    //indexPath = "D:/test/lucene/index";
    //docsPath = "D:/test/lucene/docs";
...
try
{
    ...
    indexPath = config.getString("index.path");
    docsPath = config.getString("document.path");
    
    System.out.println("index.path="+indexPath);
    System.out.println("document.path="+docsPath);
...
catch (ConfigurationException cex)
{
  ...
  static void indexDoc(IndexWriter writer, Path file, long lastModified) throws IOException {
    try (InputStream stream = Files.newInputStream(file)) {
      ...
      String data = opentext(file.toString());
